...
export const PRIZE_BUSINESS_MODEL = {
  ...
  weeksPerMonth: 4,
  winnersPerWeek: 5,
  minConsecutiveStampsForEligibility: 7, // רצף 7 לחיצות מדויקות בחלון 60 שניות לפני השבוע
...
export function formatPrizeEconomicsForAI(
  ...
  const lines = [
    ...
    "",
    "זוכים: 5 הדייקניים ביותר כל שבוע (קרובים ביותר לשעת ה-DNA שלהם במילישניות).",
    "חלוקת הקופה השבועית: ביחס ישר למספר ימי ההשתתפות של כל זוכה באותו חודש (לא אחוזים קבועים).",
    "שוויון מלא (אותן מילישניות + אותם ימי השתתפות): חלקם מתחלק שווה בשווה.",
    "",
    "זכאות לפרס (תקנון): מנוי premium פעיל; רצף 7 לחיצות מדויקות בחלון 60 שניות לפני תחילת השבוע; חתימות רק משרת (anti-cheat).",
    "",
