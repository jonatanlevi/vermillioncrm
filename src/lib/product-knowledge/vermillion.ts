...
export const PRODUCT_KNOWLEDGE_VERSION = "2026-05-23";
...
מנוי premium: אונבורדינג 7 ימים, ימים 9–30 אימון, תחרות שבועית ופרסים. free: מוגבל.
פרס: N×₪99 → 20% תפעול → 80% נטו → 50% קרן פרסים (÷4 שבועות, 5 זוכים לפי ימי השתתפות) + 50% רווח מועדון; זכאות: רצף 7 לחיצות מדויקות (חלון 60 שניות) לפני השבוע.
...
## מה זה
פלטפורמת אימון פיננסי אישי: משחקים יומיים, חתימה (Stamp) בזמן DNA, תחרות שבועית עם קופת פרסים דינמית.
...
נוסחה: N×₪99 → **20% תפעול** (ניתן לשינוי) → **80% נטו** → 50% קרן פרסים + 50% רווח מועדון.
סה"כ קרן = 40% מהכנסות. מתחלקת ל-4 שבועות. אין מינימום מובטח.

חלוקת קופה שבועית: **5 הדייקניים ביותר** (קרובים ביותר ל-DNA/יעד במילישניות).
נתח כל זוכה = **ביחס ישר למספר ימי ההשתתפות שלו באותו חודש**.
שוויון מלא (אותן מילישניות + אותם ימי השתתפות) → חלקם מתחלק שווה בשווה.

טבלת דוגמאות — קרן שבועית לפי גודל קהילה:
| משתמשים | קרן שבועית (40% מהכנסות ÷4) |
| 50      | ~₪495                        |
| 200     | ~₪1,980                      |
| 500     | ~₪4,950                      |
| 1,000   | ~₪9,900                      |
...
תנאי זכאות: premium פעיל; **רצף 7 לחיצות מדויקות בחלון 60 שניות לפני תחילת השבוע**; חתימות מאומתות בשרת; top 5 בדייקנות שבועית.
...
- זכאות לתחרות: רצף 7 לחיצות מדויקות (חלון 60 שניות סביב DNA) לפני אותו שבוע
- חלוקת פרס: 5 הדייקניים, ביחס ימי השתתפות בחודש
